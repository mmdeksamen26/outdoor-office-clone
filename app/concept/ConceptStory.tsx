  ...
  return (
    <>
      ...
      <section className="grid w-full grid-cols-2">
        <motion.div {...fadeUp} className="relative h-[820px] w-full overflow-hidden">
          <Image src="/billeder/joederloeb.JPG" alt="Outdoor Office" fill className="object-cover object-[center_35%]" />
        </motion.div>
      ...
      <motion.section {...fadeUp} className="relative h-[620px] w-full overflow-hidden">
        <Image src="/billeder/STORYGruppebillede1.JPG" alt="Outdoor Office group" fill className="object-cover object-[center_52%]" />
      </motion.section>
      ...
      {/* stort billede */}
      <motion.section {...fadeUp} className="relative h-[700px] w-full overflow-hidden">
      ...
      <section className="grid min-h-[600px] w-full grid-cols-2">
        ...
        <motion.div {...fadeUp} className="relative h-full min-h-[600px] w-full overflow-hidden">
